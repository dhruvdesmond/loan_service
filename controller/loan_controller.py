...
from models.loan import LoanModel, LoanInsertModel, AmountInsertModel
...
async def add_repayment_by_customer(loan_uuid: str, repayment_uuid: str,amount: AmountInsertModel, _=Depends(build_request_context)):
    """
